...
proc mpz_addmul(a2: var mpz_t; a3: mpz_t; a4: mpz_t) {.importc: "__gmpz_addmul", 
    dynlib: libgmp, cdecl.}
...
proc mpz_cdiv_q(a2: var mpz_t; a3: mpz_t; a4: mpz_t) {.importc: "__gmpz_cdiv_q", 
    dynlib: libgmp, cdecl.}
...
proc mpz_cdiv_r(a2: var mpz_t; a3: mpz_t; a4: mpz_t) {.importc: "__gmpz_cdiv_r", 
    dynlib: libgmp, cdecl.}
...
proc mpz_com(a2: mpz_ptr; a3: mpz_srcptr) {.importc: "__gmpz_com", 
    dynlib: libgmp, cdecl.}
proc mpz_com(a2: var mpz_t; a3: mpz_t) {.importc: "__gmpz_com", 
    dynlib: libgmp, cdecl.}
...
proc mpz_mfac_uiui(a2: var mpz_t; a3: culong; a4: culong) {.
    importc: "__gmpz_mfac_uiui", dynlib: libgmp, cdecl.}
proc mpz_primorial_ui(a2: mpz_ptr; a3: culong) {.importc: "__gmpz_primorial_ui", 
    dynlib: libgmp, cdecl.}
...
proc mpz_fdiv_q(a2: var mpz_t; a3: mpz_t; a4: mpz_t) {.importc: "__gmpz_fdiv_q", 
    dynlib: libgmp, cdecl.}
...
proc mpz_fdiv_r(a2: var mpz_t; a3: mpz_t; a4: mpz_t) {.importc: "__gmpz_fdiv_r", 
    dynlib: libgmp, cdecl.}
...
proc mpz_hamdist(a2: mpz_t; a3: mpz_t): mp_bitcnt_t {.importc: "__gmpz_hamdist", 
    dynlib: libgmp, cdecl.}
...
proc mpz_init2(a2: var mpz_t; a3: mp_bitcnt_t) {.importc: "__gmpz_init2", 
    dynlib: libgmp, cdecl.}
proc mpz_inits(a2: mpz_ptr) {.varargs, importc: "__gmpz_inits", 
                              dynlib: libgmp, cdecl.}
...
proc mpz_init_set_ui(a2: mpz_ptr; a3: culong) {.importc: "__gmpz_init_set_ui", 
    dynlib: libgmp, cdecl.}
proc mpz_init_set_ui(a2: var mpz_t; a3: culong) {.importc: "__gmpz_init_set_ui", 
    dynlib: libgmp, cdecl.}
...
proc mpz_millerrabin(a2: mpz_t; a3: cint): cint {.importc: "__gmpz_millerrabin", 
    dynlib: libgmp, cdecl.}
...
proc mpz_mul_si(a2: var mpz_t; a3: mpz_t; a4: clong) {.importc: "__gmpz_mul_si", 
    dynlib: libgmp, cdecl.}
...
proc mpz_set(a2: mpz_ptr; a3: mpz_srcptr) {.importc: "__gmpz_set", 
    dynlib: libgmp, cdecl.}
proc mpz_set(a2: var mpz_t; a3: mpz_t) {.importc: "__gmpz_set", 
    dynlib: libgmp, cdecl.}
...
proc mpz_submul(a2: var mpz_t; a3: mpz_t; a4: mpz_t) {.importc: "__gmpz_submul", 
    dynlib: libgmp, cdecl.}
...
proc mpz_tdiv_q(a2: var mpz_t; a3: mpz_t; a4: mpz_t) {.importc: "__gmpz_tdiv_q", 
    dynlib: libgmp, cdecl.}
...
proc mpz_tdiv_r(a2: var mpz_t; a3: mpz_t; a4: mpz_t) {.importc: "__gmpz_tdiv_r", 
    dynlib: libgmp, cdecl.}
...
proc mpq_inits(a2: mpq_ptr) {.varargs, importc: "__gmpq_inits", 
                              dynlib: libgmp, cdecl.}
...
proc mpq_inv(a2: mpq_ptr; a3: mpq_srcptr) {.importc: "__gmpq_inv", 
    dynlib: libgmp, cdecl.}
proc mpq_inv(a2: var mpq_t; a3: mpq_t) {.importc: "__gmpq_inv", 
    dynlib: libgmp, cdecl.}
...
proc mpq_set(a2: mpq_ptr; a3: mpq_srcptr) {.importc: "__gmpq_set", 
    dynlib: libgmp, cdecl.}
proc mpq_set(a2: var mpq_t; a3: mpq_t) {.importc: "__gmpq_set", 
    dynlib: libgmp, cdecl.}
...
proc mpq_set_str(a2: var mpq_t; a3: cstring; a4: cint): cint {.
    importc: "__gmpq_set_str", dynlib: libgmp, cdecl.}
proc mpq_set_ui(a2: mpq_ptr; a3: culong; a4: culong) {.importc: "__gmpq_set_ui", 
    dynlib: libgmp, cdecl.}
...
proc mpf_abs(a2: mpf_ptr; a3: mpf_srcptr) {.importc: "__gmpf_abs", 
    dynlib: libgmp, cdecl.}
proc mpf_abs(a2: var mpf_t; a3: mpf_t) {.importc: "__gmpf_abs", 
    dynlib: libgmp, cdecl.}
...
proc mpf_eq(a2: mpf_t; a3: mpf_t; a4: mp_bitcnt_t): cint {.importc: "__gmpf_eq", 
    dynlib: libgmp, cdecl.}
...
proc mpf_init2(a2: var mpf_t; a3: mp_bitcnt_t) {.importc: "__gmpf_init2", 
    dynlib: libgmp, cdecl.}
proc mpf_inits(a2: mpf_ptr) {.varargs, importc: "__gmpf_inits", 
                              dynlib: libgmp, cdecl.}
...
proc mpf_init_set_ui(a2: mpf_ptr; a3: culong) {.importc: "__gmpf_init_set_ui", 
    dynlib: libgmp, cdecl.}
proc mpf_init_set_ui(a2: var mpf_t; a3: culong) {.importc: "__gmpf_init_set_ui", 
    dynlib: libgmp, cdecl.}
...
proc mpf_neg(a2: mpf_ptr; a3: mpf_srcptr) {.importc: "__gmpf_neg", 
    dynlib: libgmp, cdecl.}
proc mpf_neg(a2: var mpf_t; a3: mpf_t) {.importc: "__gmpf_neg", 
    dynlib: libgmp, cdecl.}
...
proc mpf_set(a2: mpf_ptr; a3: mpf_srcptr) {.importc: "__gmpf_set", 
    dynlib: libgmp, cdecl.}
proc mpf_set(a2: var mpf_t; a3: mpf_t) {.importc: "__gmpf_set", 
    dynlib: libgmp, cdecl.}
proc mpf_set_d(a2: mpf_ptr; a3: cdouble) {.importc: "__gmpf_set_d", 
    dynlib: libgmp, cdecl.}
proc mpf_set_d(a2: var mpf_t; a3: cdouble) {.importc: "__gmpf_set_d", 
    dynlib: libgmp, cdecl.}
proc mpf_set_default_prec(a2: mp_bitcnt_t) {.importc: "__gmpf_set_default_prec", 
    dynlib: libgmp, cdecl.}
...
proc mpf_size(a2: mpf_srcptr): csize {.importc: "__gmpf_size", dynlib: libgmp, 
                                       cdecl.}
proc mpf_size(a2: mpf_t): csize {.importc: "__gmpf_size", dynlib: libgmp, 
                                  cdecl.}
...
proc mpn_mul(a2: mp_ptr; a3: mp_srcptr; a4: mp_size_t; a5: mp_srcptr; 
             a6: mp_size_t): mp_limb_t {.importc: "__gmpn_mul", 
    dynlib: libgmp, cdecl.}
...
proc mpn_preinv_mod_1(a2: mp_srcptr; a3: mp_size_t; a4: mp_limb_t; a5: mp_limb_t): mp_limb_t {.
...
proc mpn_sub(a2: mp_ptr; a3: mp_srcptr; a4: mp_size_t; a5: mp_srcptr; 
             a6: mp_size_t): mp_limb_t {.importc: "__gmpn_sub", 
    dynlib: libgmp, cdecl.}
...
proc mpz_fits_ushort_p(mm_gmp_z: mpz_t): cint {.importc: "__gmpz_fits_ushort_p", 
    dynlib: libgmp, cdecl.}
...
proc mpz_size(mm_gmp_z: mpz_srcptr): csize {.importc: "__gmpz_size", 
    dynlib: libgmp, cdecl.}
proc mpz_size(mm_gmp_z: mpz_t): csize {.importc: "__gmpz_size", 
                                        dynlib: libgmp, cdecl.}
